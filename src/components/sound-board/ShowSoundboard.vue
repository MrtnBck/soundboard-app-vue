<template>
  <card-dashboard>
    <base-button v-if="isActive" @click="stopAutoplay">Autoplay On</base-button>
    <base-button v-if="!isActive" @click="startAutoplay">Autoplay Off</base-button>
  </card-dashboard>
  <card-soundboard>
    <tile-audio
      v-for="sound in storedSounds"
      :key="sound.id"
      :id="sound.id"
      :file="sound.sound"
      :label="sound.label"
...
<script>
import TileAudio from '../audio-components/TileAudio.vue';
import CardSoundboard from './CardSoundboard.vue';
import CardDashboard from '../dashboard-components/CardDashboard.vue';
export default {
  components: {
    TileAudio,
    CardSoundboard,
